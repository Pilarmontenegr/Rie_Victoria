...
urlpatterns = [path ('',views.index, name='index'),
            ...
            #    path ('compras/<int:pk>/',views.compras, name='compras'),
               ...
               path ('tablaproveedores/',views.tablaproveedores.as_view(), name='tablaproveedores'),
               ...
               path ('tablaempleados/',views.tablaempleados.as_view(), name='tablaempleados'),
               ...
               path ('tablaclientes/',views.tablaClientes.as_view(), name='tablaclientes'),
               ...
               path('tabla/', views.tabla.as_view(), name='tabla'),
